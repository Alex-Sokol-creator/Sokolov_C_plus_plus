...

	{
		...
		while (true) {
			...
			switch (choice) {
				...
				case 2: {
					cout << "Из какой валюты вы хотите провести конвертацию? (1 - UAH, 2 - EUR, 3 - USD, 4 - GBP, 5 - PLN): ";
					cin >> choicemoney1;
					if (choicemoney1 < 1 || choicemoney1 > 5) {
						cout << "К сожалению, сейчас такой валюты нет\n";
						break;
					}
					...
					cout << "В какую валюту вы хотите конвертировать? (1 - UAH, 2 - EUR, 3 - USD, 4 - GBP, 5 - PLN): ";
					cin >> choicemoney2;
					switch (choicemoney2) {
						case 1: {
						...
						default: {
							cout << "Вы ввели недоступный знак\n";
							break;
						}
					}
				}
