...
int main()
{
	...
	{
		cout << "\nNinth Task\n";
		cout << "Введите символ, которым вы хотите заполнить фигуру: ";
		char symbol;
		cin >> symbol;
		int figure;
		while (true) {
			cout << "Введите, какую фигуру вы хотите заполнить (1 - квадрат, 2 - прямоугольник, 3 - треугольник): ";
			cin >> figure;
			if (figure != 1 && figure != 2 && figure != 3) {
				cout << "К сожалению, такой фигуры сейчас нет, попробуйте заново\n";
			}
			else { break; }
		}
		switch (figure) {
